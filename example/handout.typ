...
$
$eta_3$:本体形变。
普弹形变和高弹形变均为可逆形变，粘性流动为不可逆形变。
高聚物受到外力作用时以上三种形变是一起发生的，材料的总形变为：
$
...
但用$gamma-tau$确定屈服应力的方法的缺点是，第二段拟合曲线可以选择的方式较多，得到的屈服应力数值不固定。
故还有一种方法确定宾汉流体的屈服应力，即$eta-tau$测试，将该曲线的极大值点作为屈服应力。
